...
const CustomerCard = ({ customer }: {
    ...
    return <div className="mb-0 px-0 max-w-full basis-full md:max-w-[50%] lg:max-w-[25%] md:basis-1/2 lg:basis-[25%] flex-1 bg-transparent">
        <div className="flex mx-[15px] mb-[30px] pb-[24px] justify-center flex-col items-center text-center overflow-hidden py-[32px] rounded-[3px] bg-white shadow-[1px_0_12px_0_rgba(0,0,0,.12)]">
            <div className="flex overflow-hidden h-auto md:h-[160px] mt-[-32px] mb-4 -mx-4 pt-0 justify-center items-center w-full">
            ...
            <div className=" flex w-auto h-[24px] mt-3 px-3 flex-nowrap items-center content-center rounded-[20px] bg-sec-brand-400">
    ...
    return <>
        <div className=" py-[104px] bg-[#e9e8f0]" id="services">
            <div className=" container">
                ...
                <div className=" mx-[-7.5px] bg-scroll flex flex-wrap lg:justify-start gap-y-2" style={{alignContent: 'stretch'}}>
                    {
                        details.map((a, ind) => {
                            return <div key={ind} className="mb-0 px-0 flex-1 bg-transparent max-w-full basis-full md:max-w-[50%] lg:max-w-none md:basis-1/2 lg:basis-0">
                                <div className="overflow-hidden mx-[7.5px] py-8 px-4 rounded-[3px] bg-white shadow-[1px_0_12px_0_rgba(0,0,0,.12)] flex flex-row lg:flex-col pb-6">
                                    ...
                                    <div>
                                        <h6 className="!text-left lg:!text-center mb-2">{a.title}</h6>
                                        <p className="!text-left lg:!text-center mb-0 text-xs leading-5">{a.subtitle}</p>
                                    </div>
                                </div>
                            </div>
                        })
        ...
        <div className=" relative pt-[104px] pb-6 bg-[#f5f4f7]" id="projects">
            <div className="container">
                <div className="my-0 justify-center items-center flex mx-[-15px] flex-wrap">
                    <div className="  max-w-[75%] basis-[75%]  mb-4 px-[15px] flex-1">
                        <div className=" flex mb-[40px] flex-col text-center">
                ...
                <div className="my-0 justify-center items-center flex mx-[-15px] flex-wrap">
                    <div className="max-w-full basis-full lg:max-w-[83.333%] lg:basis-[83.333%] mb-4 px-[15px] flex-1">
